...
import { canAccessCase, canAccessComplianceWorkspace, canPerformKycOperations } from '@/lib/auth/roles';
...
export default async function ComplianceSubmittedCasesPage() {
  ...
  if (!canPerformKycOperations(user) && !canAccessComplianceWorkspace(user)) redirect('/');
